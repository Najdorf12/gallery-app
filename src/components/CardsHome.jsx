const CardsHome = ({ artist }) => {
  return (
    <div className="relative z-50 border-l-[2px] border-b-[2px] border-zinc-600 w-[160px] rounded-sm h-[110px] pl-3 pt-1 lg:pl-3 lg:w-[220px] lg:h-[135px] xl:w-[240px] xl:h-[140px]  2xl:w-[250px] 2xl:h-[160px] hover:border-white duration-500 cursor-pointer">
      <figure>
