...
const CardsHome = ({ artist }) => {
  return (
    <Link to={`/${artist?.id}`}>
      <div className="relative z-50 border-l-[2px] border-b-[2px] border-stone-700 w-[180px] rounded-sm h-[114px] pl-3 pt-2  lg:pl-3 lg:w-[220px] lg:h-[133px] xl:w-[255px] xl:h-[152px]  2xl:w-[280px] 2xl:h-[178px] hover:border-white duration-500 cursor-pointer">
        <figure>
          <img
            src={artist?.icon}
            alt="icon"
