...
const CardsHome = ({ artist }) => {
  return (
    <Link to={`/${artist?.id}`}>
      <div className="relative z-50 border-l-[2px] border-b-[2px] border-stone-700 w-[180px] rounded-sm h-[114px] pl-3 pt-2  lg:pl-3 lg:w-[220px] lg:h-[140px] xl:w-[237px] xl:h-[145px]  2xl:w-[280px] 2xl:h-[167px] hover:border-white duration-500 cursor-pointer">
        <figure>
          <img
            src={artist?.icon}
            alt="icon"
        ...
        <article className="text-sm mt-4  md:text-balance lg:text-base xl:mt-5 xl:text-lg 2xl:mt-6  2xl:text-lg">
          <h6 className="text-stone-300 font-text font-medium text-lg  xl:text-xl 2xl:text-2xl">
            {artist?.name}
          </h6>
