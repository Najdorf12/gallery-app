const CardsHome = ({ artist }) => {
  return (
    <div className="relative z-50 border-l border-b border-zinc-600 w-[160px] h-[110px] pl-3 lg:pl-5 lg:w-[200px] lg:h-[135px] 2xl:w-[250px] 2xl:h-[158px]">
      <figure>
        <img src={artist?.icon} alt="icon" className="w-9 lg:w-12 xl:w-16 2xl:w-20" />
      </figure>
