        ...
        <div ref={containerRef} className="relative">
          {activeArticle === "project" && (
            <article className="flex flex-col justify-start items-start relative z-50 w-full cursor-default  mt-20 xl:mt-24 2xl:mt-28">
              <h1 className="august-bold leading-[4.8rem] text-zinc-300  text-7xl max-w-[400px] lg:max-w-[600px] lg:leading-[8.1rem] lg:text-[8rem] 2xl:text-[10rem] 2xl:max-w-[800px] 2xl:leading-[10.1rem]">
              ...
              <p className="text-sm text-grayCustom font-text2 font-medium text-balance mt-4 max-w-[800px]   lg:mt-5 lg:text-base 2xl:text-lg 2xl:max-w-[920px]">
